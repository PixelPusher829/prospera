				...
				<div className="p-6 space-y-4">
					<div>
						...
						<input
							...
							className={`w-full px-3 py-2 border rounded-lg transition-colors dark:bg-slate-900 dark:text-white ${errors.payee ? "border-red-500" : "border-slate-200 dark:border-slate-600"}`}
							placeholder="e.g., Amazon, Salary"
						/>
						{errors.payee && (
							<p className="text-xs text-red-500 mt-1">{errors.payee}</p>
						)}
					</div>
					<div className="grid grid-cols-2 gap-4">
						<div>
							...
							<div className="relative">
								...
								<input
									...
									onChange={handleInputChange}
									className={`w-full pl-7 pr-3 py-2 border rounded-lg transition-colors dark:bg-slate-900 dark:text-white ${errors.amount ? "border-red-500" : "border-slate-200 dark:border-slate-600"}`}
									placeholder="0.00"
								/>
							</div>
							{errors.amount && (
						...
						<div>
							...
							<select
								...
								onChange={handleInputChange}
								className="w-full px-3 py-2 border rounded-lg bg-white dark:bg-slate-900 dark:text-white border-slate-200 dark:border-slate-600"
							>
					...
					<div>
						...
						<input
							...
							onChange={handleInputChange}
							className="w-full px-3 py-2 border rounded-lg dark:bg-slate-900 dark:text-white border-slate-200 dark:border-slate-600"
						/>
					</div>
					<div>
						<label className="block text-sm font-medium text-slate-600 mb-1">
