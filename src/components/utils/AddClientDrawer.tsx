					...
					<div className="flex-1 overflow-y-auto p-6 space-y-6">
						<div className="space-y-4">
							<div>
								...
								<div
									className={`flex items-center gap-2 px-3 py-2 border rounded-xl transition-all ${errors.name ? "border-red-500" : "border-slate-200 focus-within:ring-2 focus-within:ring-violet-500/20 focus-within:border-violet-500"}`}
								>
							...
							<div>
								...
								<div
									className={`flex items-center gap-2 px-3 py-2 border rounded-xl transition-all ${errors.email ? "border-red-500" : "border-slate-200 focus-within:ring-2 focus-within:ring-violet-500/20 focus-within:border-violet-500"}`}
								>
							...
							<div>
								...
								<div
									className={`flex items-center gap-2 px-3 py-2 border rounded-xl transition-all ${errors.company ? "border-red-500" : "border-slate-200 focus-within:ring-2 focus-within:ring-violet-500/20 focus-within:border-violet-500"}`}
								>
