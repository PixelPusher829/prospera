...
const FAQItem: React.FC<{ question: string; answer: string }> = ({
	...
	return (
		<div className="border border-slate-200 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-800 overflow-hidden">
			...
			<div
				className={`px-5 text-slate-600 dark:text-slate-300 transition-all duration-300 ${isOpen ? "max-h-48 pb-5 opacity-100" : "max-h-0 opacity-0"}`}
			>
				{answer}
			</div>
		</div>
	...
	return (
		<div className="p-6 lg:p-10 max-w-[1200px] mx-auto min-h-full">
			<div className="text-center mb-12">
				<h1 className="text-4xl font-bold text-slate-700 dark:text-white mb-4">
					How can we help you?
				</h1>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
				<div className="bg-violet-50 dark:bg-slate-800 p-6 rounded-3xl text-center hover:-translate-y-1 transition-transform">
					...
					<button className="text-violet-600 dark:text-violet-400 font-semibold text-sm hover:underline">
						Read Docs
					</button>
				</div>
				...
				<div className="bg-emerald-50 dark:bg-slate-800 p-6 rounded-3xl text-center hover:-translate-y-1 transition-transform">
					...
					<button className="text-emerald-600 dark:text-emerald-400 font-semibold text-sm hover:underline">
						Send Email
					</button>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-1 gap-12">
				<div>
					<h2 className="text-2xl font-bold text-slate-700 dark:text-white mb-6">
