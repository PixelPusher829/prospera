	...
	return (
		<div className="p-6 lg:p-10 max-w-[1600px] mx-auto space-y-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				{/* Net Worth */}
				<div className="bg-slate-900 dark:bg-violet-900/20 p-6 rounded-3xl shadow-xl text-white flex flex-col justify-between h-48 relative overflow-hidden group">
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
				...
				<div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-6">
					<h3 className="font-bold text-lg text-slate-700 dark:text-white mb-6">
						Cash Flow
					</h3>
						...
						<div className="pt-6 border-t border-slate-100 dark:border-slate-700">
							...
							<div className="space-y-3">
								...
								<div className="border-t border-slate-100 dark:border-slate-700 pt-2 flex justify-between text-sm font-bold">
									...
									<span className="text-900 dark:text-white">
										$17.40
									</span>
								</div>
							</div>
