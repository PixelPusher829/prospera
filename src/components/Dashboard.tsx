	...
	return (
		<div className="p-6 lg:p-10 max-w-[1600px] mx-auto space-y-8">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				{/* Net Worth */}
				<div className="bg-slate-900 dark:bg-violet-900/20 dark:border dark:border-violet-500/20 p-6 rounded-3xl shadow-xl text-white flex flex-col justify-between h-48 relative overflow-hidden group">
				...
				{/* Monthly Budget Left */}
				<div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col justify-between h-48">
					<div>
						...
						<p className="text-xs text-slate-400">
							Based on your "Shopping" & "Dining" budgets
						</p>
					</div>
					<div>
				...
				<div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 flex flex-col h-48 overflow-y-auto">
