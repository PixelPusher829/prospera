...
const FAQItem: React.FC<{ question: string; answer: string }> = ({ question, answer }) => {
  ...
  return (
    <div className="border border-slate-200 dark:border-slate-700 rounded-2xl bg-white dark:bg-slate-800 overflow-hidden">
      ...
      >
        <span className="font-semibold text-slate-700 dark:text-white">{question}</span>
  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1200px] mx-auto min-h-full">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-slate-700 dark:text-white mb-4">How can we help you?</h1>
        <div className="max-w-xl mx-auto relative">
          <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={20} />
          <input 
            type="text" 
            placeholder="Search for answers..." 
            className="w-full pl-12 pr-4 py-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg shadow-slate-200/50 dark:shadow-none bg-white dark:bg-slate-800 text-slate-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-violet-500"
          />
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        <div className="bg-violet-50 dark:bg-slate-800 p-6 rounded-3xl text-center hover:-translate-y-1 transition-transform">
          ...
          <h3 className="font-bold text-lg text-slate-700 dark:text-white mb-2">Documentation</h3>
        ...
        <div className="bg-blue-50 dark:bg-slate-800 p-6 rounded-3xl text-center hover:-translate-y-1 transition-transform">
          ...
          <h3 className="font-bold text-lg text-slate-700 dark:text-white mb-2">Live Chat</h3>
        ...
        <div className="bg-emerald-50 dark:bg-slate-800 p-6 rounded-3xl text-center hover:-translate-y-1 transition-transform">
          ...
          <h3 className="font-bold text-lg text-slate-700 dark:text-white mb-2">Email Support</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 gap-12">
        <div>
          <h2 className="text-2xl font-bold text-slate-700 dark:text-white mb-6">Frequently Asked Questions</h2>
