...
import BankAccountRow from "../accounts/BankAccountRow";
...
const WalletOverview: React.FC<WalletOverviewProps> = ({
    ...
    <div className="grid grid-cols-1 gap-8 xl:grid-cols-3">
      <div className="space-y-8 xl:col-span-2">
        ...
        <div className="@container space-y-4 border-t border-slate-200 pt-8 dark:border-slate-700">
          <div className="flex items-center justify-between">
            <h3 className="text-xl font-bold text-slate-700 dark:text-white">
              Loans
            </h3>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 @lg:grid-cols-2">
            {creditCards.slice(0, 2).map((acc) => (
              <div
                key={acc.id}
                className="origin-top-left transform sm:origin-top sm:scale-100"
              >
