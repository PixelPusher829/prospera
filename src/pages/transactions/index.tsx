          ...
          <FilterBar>
            ...
            <div className="flex gap-3">
              <SelectField
                ...
                className="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-600 focus:ring-2 focus:ring-violet-500/20 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 min-w-max flex-shrink-0"
              >
