  ...
  const columns: Column<Client>[] = [
    {
      ...
      cell: (client) => (
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-pink-100 font-bold text-pink-600 dark:bg-red-700/30 dark:text-pink-400">
          ...
          <div>
            ...
            <div className="flex min-w-0 items-center gap-1 overflow-hidden text-xs text-ellipsis whitespace-nowrap text-slate-500 dark:text-slate-400">
