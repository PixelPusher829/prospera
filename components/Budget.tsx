    ...
    <div className="p-6 lg:p-10 max-w-[1600px] mx-auto min-h-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Keep your spending in check</p>
        </div>
      ...
      {/* Summary Header */}
      <div className="bg-slate-900 text-white p-8 rounded-3xl mb-10 flex flex-col md:flex-row justify-between items-center gap-8">
                  ...
                  <div className="flex items-start justify-between mb-4">
                     <div className="flex items-center gap-4">
                        ...
                        <div>
                           ...
                           <p className="text-xs text-slate-500">Limit: ${item.limit}</p>
                        </div>
                     </div>
                     <div className="text-right">
                        <span className={`text-xl font-bold ${isOver ? 'text-red-500' : 'text-slate-900'}`}>
                           ${item.spent}
                        </span>
                     </div>
                  </div>
